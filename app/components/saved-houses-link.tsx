...
export function SavedHousesLink({
	...
	const optimisticSavedHousesCount = fetcher?.formData?.get("optimisticCount")
		? Number(fetcher.formData.get("optimisticCount"))
		: savedHousesCount;
